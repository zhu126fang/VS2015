<?php
	...
	// Includes
	include_once('/ffx/www/includes/generic.php');
	
        $variables = array();
	$fn = "/ffx/www/variables/mnt/symbols";
	if (file_exists($fn))
	{
	...
	$(document).ready(
		function() 
		{
			...
			$.ajax({
				...
				dataType:'TEXT',
				cache: false,
				url:'/ffx/www/variables/mnt/exists',
				success:yay,
				error:aww
			});
		}		
...
<div class="section" id="<?php echo $id; ?>">
	...
	<div class="inputRow">
		...
		<input class="inputButton" onclick="document.location='/ffx/www/variables/edit.php'" value="Edit" type="button" />
	</div>
