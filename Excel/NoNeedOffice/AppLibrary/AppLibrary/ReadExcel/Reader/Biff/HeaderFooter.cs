...
using System;
using Assert = AppLibrary.common.Assert;
...
namespace AppLibrary.Biff
{
	...
	public abstract class HeaderFooter
	{
		...
		public class Contents
		{
			...
			{
                appendInternal(AppLibrary.Biff.HeaderFooter.BOLD_TOGGLE);
			}
			...
			{
                appendInternal(AppLibrary.Biff.HeaderFooter.UNDERLINE_TOGGLE);
			}
			...
			{
                appendInternal(AppLibrary.Biff.HeaderFooter.ITALICS_TOGGLE);
			}
			...
			{
                appendInternal(AppLibrary.Biff.HeaderFooter.STRIKETHROUGH_TOGGLE);
			}
			...
			{
                appendInternal(AppLibrary.Biff.HeaderFooter.DOUBLE_UNDERLINE_TOGGLE);
			}
			...
			{
                appendInternal(AppLibrary.Biff.HeaderFooter.SUPERSCRIPT_TOGGLE);
			}
			...
			{
                appendInternal(AppLibrary.Biff.HeaderFooter.SUBSCRIPT_TOGGLE);
			}
			...
			{
                appendInternal(AppLibrary.Biff.HeaderFooter.OUTLINE_TOGGLE);
			}
			...
			{
                appendInternal(AppLibrary.Biff.HeaderFooter.SHADOW_TOGGLE);
			}
