...
//		}
		...
		/// </param>
        protected internal FontRecord(string fn, int ps, int bold, bool it, int us, int ci, int ss)
            : base(AppLibrary.Biff.Type.FONT)
		{
			boldWeight = bold;
			underlineStyle = us;
			name = fn;
		...
		/// </param>
        protected internal FontRecord(Font f)
            : base(AppLibrary.Biff.Type.FONT)
		{
