...
namespace AppLibrary.Biff.Formula
{
	...
	class SharedFormulaArea:Operand, ParsedThing
	{
		...
		{
			AppLibrary.Biff.CellReferenceHelper.getCellReference(columnFirst, rowFirst, buf);
			buf.Append(':');
			AppLibrary.Biff.CellReferenceHelper.getCellReference(columnLast, rowLast, buf);
		}
	}
}
