...
namespace AppLibrary.Biff
{
    ...
    public class XFRecord : WritableRecordData, AppLibrary.Format.CellFormat
	{
		...
		/// <returns> the format
		/// </returns>
        virtual public AppLibrary.Format.Format Format
		{
			get
			{
				if (!formatInfoInitialized)
		...
		/// </summary>
        private AppLibrary.Format.Format excelFormat;
		...
		/// </param>
        protected internal XFRecord(XFRecord fmt)
            : base(AppLibrary.Biff.Type.XF)
		{
		...
		/// </param>
        protected internal XFRecord(CellFormat cellFormat)
            : base(AppLibrary.Biff.Type.XF)
		{
