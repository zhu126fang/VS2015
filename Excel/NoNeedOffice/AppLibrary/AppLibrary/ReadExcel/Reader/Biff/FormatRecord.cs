...
namespace AppLibrary.Biff
{
    ...
    public class FormatRecord : WritableRecordData, DisplayFormat, AppLibrary.Format.Format
	{
...
//					csb.Append("ss.SSS");
		...
		/// </param>
        internal FormatRecord(string fmt, int refno)
            : base(AppLibrary.Biff.Type.FORMAT)
		{
			formatString = fmt;
			indexCode = refno;
			initialized = true;
        ...
        protected internal FormatRecord()
            : base(AppLibrary.Biff.Type.FORMAT)
		{
			initialized = false;
		}
		...
		/// </param>
        protected internal FormatRecord(FormatRecord fr)
            : base(AppLibrary.Biff.Type.FORMAT)
		{
			initialized = false;
		...
		public FormatRecord(Record t, WorkbookSettings ws, BiffType biffType):base(t)
		{
			...
			else
			{
                ...
                formatString = new string(AppLibrary.Utils.Byte.ToCharArray(AppLibrary.Utils.Byte.ToByteArray(chars)));
			}
