...
namespace AppLibrary.Biff
{
	...
	public sealed class StringHelper
	{
		...
		{
            return AppLibrary.Utils.Byte.ToSByteArray(AppLibrary.Utils.Byte.ToByteArray(s));
		}
		...
		public static sbyte[] getUnicodeBytes(string s)
		{
			try
			{
                ...
                sbyte[] b1 = AppLibrary.Utils.Byte.ToSByteArray(b0);
		...
		public static string getString(sbyte[] d, int length, int pos, WorkbookSettings ws)
		{
			try
			{
                ...
                byte[] bb = AppLibrary.Utils.Byte.ToByteArray(b);
