	...
	sealed class SheetReader 
	{
		...
		private void  addCell(Cell cell)
		{
			...
			if (cell.Row < numRows && cell.Column < numCols)
			{
				if (cells[cell.Row][cell.Column] != null)
				{
                    ...
                    AppLibrary.ReadExcel.CellReferenceHelper.getCellReference(cell.Column, cell.Row, sb);
		...
		internal void  read()
		{
			...
			while (cont)
			{
                ...
                if (r.Type == AppLibrary.Biff.Type.UNKNOWN && r.Code == 0)
				{
					...
					if (r.Length == 0xa)
					{
                        ...
                        r.Type = (AppLibrary.Biff.Type.DIMENSION);
					}
					else
					{
                ...
                if (r.Type == AppLibrary.Biff.Type.DIMENSION)
				{
                ...
                else if (r.Type == AppLibrary.Biff.Type.LABELSST)
				{
					LabelSSTRecord label = new LabelSSTRecord(r, sharedStrings, formattingRecords, sheet);
					addCell(label);
				}
                else if (r.Type == AppLibrary.Biff.Type.RK || r.Type == AppLibrary.Biff.Type.RK2)
				{
                ...
                else if (r.Type == AppLibrary.Biff.Type.HLINK)
				{
					HyperlinkRecord hr = new HyperlinkRecord(r, sheet, workbookSettings);
					hyperlinks.Add(hr);
				}
                else if (r.Type == AppLibrary.Biff.Type.MERGEDCELLS)
				{
                ...
                else if (r.Type == AppLibrary.Biff.Type.MULRK)
				{
                ...
                else if (r.Type == AppLibrary.Biff.Type.NUMBER)
				{
                ...
                else if (r.Type == AppLibrary.Biff.Type.BOOLERR)
				{
                ...
                else if (r.Type == AppLibrary.Biff.Type.PANE)
				{
                ...
                else if (r.Type == AppLibrary.Biff.Type.CONTINUE)
				{
					;
				}
                else if (r.Type == AppLibrary.Biff.Type.NOTE)
				{
					;
				}
                else if (r.Type == AppLibrary.Biff.Type.ARRAY)
				{
					;
				}
                else if (r.Type == AppLibrary.Biff.Type.PROTECT)
				{
					ProtectRecord pr = new ProtectRecord(r);
					settings.Protected=(pr.IsProtected());
				}
                else if (r.Type == AppLibrary.Biff.Type.SHAREDFORMULA)
				{
                ...
                else if (r.Type == AppLibrary.Biff.Type.FORMULA || r.Type == AppLibrary.Biff.Type.FORMULA2)
				{
                ...
                else if (r.Type == AppLibrary.Biff.Type.LABEL)
				{
					LabelRecord lr = null;
                ...
                else if (r.Type == AppLibrary.Biff.Type.RSTRING)
				{
                ...
                else if (r.Type == AppLibrary.Biff.Type.NAME)
				{
					;
				}
                else if (r.Type == AppLibrary.Biff.Type.PASSWORD)
				{
					PasswordRecord pr = new PasswordRecord(r);
					settings.PasswordHash=(pr.PasswordHash);
				}
                else if (r.Type == AppLibrary.Biff.Type.ROW)
				{
                ...
                else if (r.Type == AppLibrary.Biff.Type.BLANK)
				{
					BlankCell bc = new BlankCell(r, formattingRecords, sheet);
					addCell(bc);
				}
                else if (r.Type == AppLibrary.Biff.Type.MULBLANK)
				{
                ...
                else if (r.Type == AppLibrary.Biff.Type.HEADER)
				{
                    ...
                    AppLibrary.ReadExcel.HeaderFooter header = new AppLibrary.ReadExcel.HeaderFooter(hr.Header);
					settings.Header = (header);
				}
                else if (r.Type == AppLibrary.Biff.Type.FOOTER)
				{
                    ...
                    AppLibrary.ReadExcel.HeaderFooter footer = new AppLibrary.ReadExcel.HeaderFooter(fr.Footer);
					settings.Footer=(footer);
				}
                else if (r.Type == AppLibrary.Biff.Type.SETUP)
				{
                ...
                else if (r.Type == AppLibrary.Biff.Type.PLS)
				{
					plsRecord = new PLSRecord(r);
				}
                else if (r.Type == AppLibrary.Biff.Type.OBJ)
				{
                ...
                else if (r.Type == AppLibrary.Biff.Type.MSODRAWING)
				{
					msoRecord = new MsoDrawingRecord(r);
				}
                else if (r.Type == AppLibrary.Biff.Type.BOF)
				{
                    ...
                    while (r2.Code != AppLibrary.Biff.Type.EOF.Value)
					{
						r2 = excelFile.next();
					}
                ...
                else if (r.Type == AppLibrary.Biff.Type.EOF)
				{
					cont = false;
				}
			}
