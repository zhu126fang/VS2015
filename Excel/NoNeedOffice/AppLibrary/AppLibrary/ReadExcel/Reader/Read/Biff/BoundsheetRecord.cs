	...
	class BoundsheetRecord:RecordData
	{
		...
		public BoundsheetRecord(Record t):base(t)
		{
			...
			if (data[7] == 0)
			{
                ...
                name = new string(AppLibrary.Utils.Byte.ToCharArray(AppLibrary.Utils.Byte.ToByteArray(bytes)));
			}
			else
			{
				...
				try
				{
                    ...
                    //					name = new string(AppLibrary.Utils.Byte.ToCharArray(AppLibraryUtils.Byte.ToByteArray(bytes)));
                    byte[] bb = AppLibrary.Utils.Byte.ToByteArray(bytes);
