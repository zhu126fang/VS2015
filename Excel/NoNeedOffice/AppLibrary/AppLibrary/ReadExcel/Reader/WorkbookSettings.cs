...
namespace AppLibrary.ReadExcel
{
	...
	public sealed class WorkbookSettings
	{
        ...
        /// from abroad.  This may also be set using the system property AppLibrary.encoding
		/// </summary>
...
//			try
//			{
            //				      boolean suppressWarnings = Boolean.getBoolean("NExAppLibrarycel.nowarnings");
//				      setSuppressWarnings(suppressWarnings);
            //				      drawingsDisabled        = Boolean.getBoolean("AppLibrary.nodrawings");
            //				      namesDisabled           = Boolean.getBoolean("AppLibrary.nonames");
            //				      gcDisabled              = Boolean.getBoolean("AppLibrary.nogc");
            //				      rationalizationDisabled = Boolean.getBoolean("AppLibrary.norat");
//				      formulaReferenceAdjustDisabled =
            //				                                Boolean.getBoolean("AppLibrary.noformulaadjust");
//				
...
//			}
			...
			try
			{
                ...
                //	  if (System.getProperty("AppLibrary.lang")    == null ||
                //          System.getProperty("AppLibrary.country") == null)
				//      {
				//        locale = Locale.getDefault();
				//      }
				//      else
				//      {
                //        locale = new Locale(System.getProperty("AppLibrary.lang"),
                //                            System.getProperty("AppLibrary.country"));
				//      }
				//
                //      if (System.getProperty("AppLibrary.encoding") != null)
				//      {
                //        encoding = System.getProperty("AppLibrary.encoding");
				//      }
