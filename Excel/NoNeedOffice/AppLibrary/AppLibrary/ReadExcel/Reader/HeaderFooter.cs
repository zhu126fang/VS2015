...
using Contents = AppLibrary.Biff.HeaderFooter.Contents;
namespace AppLibrary.ReadExcel
{
	
	/// <summary> Class which represents an Excel header or footer. </summary>
    public sealed class HeaderFooter : AppLibrary.Biff.HeaderFooter
	{
		...
		public Contents Right
		{
			get
			{
				return (Contents) base.RightText;
			}
		...
		public Contents Centre
		{
			get
			{
				return (Contents) base.CentreText;
			}
		...
		//   */
        //  public static class Contents extends AppLibrary.Biff.HeaderFooter.Contents
		//  {
		////    /**
		////     * The constructor
		////     */
		...
		/// </param>
		public HeaderFooter(HeaderFooter hf):base(hf)
		{
		}
		...
		/// </summary>
		public HeaderFooter(string s):base(s)
		{
		}
        ...
        protected internal override AppLibrary.Biff.HeaderFooter.Contents createContents()
		{
			return new Contents(this);
		}
		
		/// <summary> Creates internal class of the appropriate type</summary>
        protected internal override AppLibrary.Biff.HeaderFooter.Contents createContents(string s)
		{
			return new Contents(this, s);
		}
		
		/// <summary> Creates internal class of the appropriate type</summary>
        protected internal override AppLibrary.Biff.HeaderFooter.Contents createContents(AppLibrary.Biff.HeaderFooter.Contents c)
		{
			return new Contents(this, (Contents) c);
		}
	}
}
