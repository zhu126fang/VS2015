...
{ 
	...
	public abstract class Workbook 
	{
		...
		public static Workbook getWorkbook(string filename, WorkbookSettings ws)
		{
            ...
            AppLibrary.Read.Biff.File dataFile = null;
			
			try
			{
                dataFile = new AppLibrary.Read.Biff.File(fis, ws);
			}
			catch (Exception e)
			{
				fis.Close();
		...
		{
            AppLibrary.Read.Biff.File dataFile = new AppLibrary.Read.Biff.File(stream, ws);
